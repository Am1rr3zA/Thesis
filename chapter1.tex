...
% I prefer a shorter sentence:
% A system call is a request in a Unix-like operating system made via a software interrupt. Typically, an active process for a service performed by the kernel raises such a software interrupt.
...
% I am not sure about the meaning of "Manifestation", but I am really doubt that you want to say "Manifestations of a wide variety of attacks differ from normal behavior of privileged processes", Note that when you use "and", you impose the previous sentence subject for the next sentence.
...
% I am not sure if "compromise" is correct word. 
